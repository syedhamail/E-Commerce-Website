...
export default function MenMoonstoneSneaker() {
  // Product details
  const product = {
    id: 1,
    ...
    price: 74.9,
    image:
      "https://websitedemos.net/recycled-shoe-store-04/wp-content/uploads/sites/983/2021/11/recycled-shoe-product-image-018-400x400.jpg",
  };

...
export default function MenClassicBlue() {
  const product = {
    id: 1,
    ...
    originalPrice: 79.9,
    image:
      "https://websitedemos.net/recycled-shoe-store-04/wp-content/uploads/sites/983/2021/11/recycled-shoe-product-image-019-400x400.jpg",
  };
    ...
    <main>
      ...
      <header className="bg-white text-sm">
        <div className="flex p-5">
          <Link href={"/"}>
            <h1 className="ml-7 text-xl font-bold md:py-1">SHMUQ SHOE</h1>
          </Link>

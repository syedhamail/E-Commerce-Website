...
export default function WomenCandyCityRun(){
      ...
      const product = {
        ...
        price: 40.00,
        image:
          "https://websitedemos.net/recycled-shoe-store-04/wp-content/uploads/sites/983/2021/11/recycled-shoe-product-image-014-400x400.jpg",
      };
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <del className="opacity-50 mr-1">${product.originalPrice}0 </del>
        ${product.price}.00
            </span>

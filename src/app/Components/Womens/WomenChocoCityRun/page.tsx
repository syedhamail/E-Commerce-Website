...
export default function WomenChocoCityRun(){
      ...
      const product = {
        ...
        price: 64.00,
        image:
          "https://websitedemos.net/recycled-shoe-store-04/wp-content/uploads/sites/983/2021/11/recycled-shoe-product-image-013-400x400.jpg",
      };

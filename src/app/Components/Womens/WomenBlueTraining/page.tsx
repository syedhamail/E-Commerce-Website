...
export default function WomenBlueTraining(){
      ...
      const product = {
        ...
        price: 60.00,
        image:
          "https://websitedemos.net/recycled-shoe-store-04/wp-content/uploads/sites/983/2021/11/recycled-shoe-product-image-003-400x400.jpg",
      };

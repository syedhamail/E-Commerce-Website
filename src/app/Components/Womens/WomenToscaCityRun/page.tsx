...
export default function WomenToscaCityRun(){
      ...
      const product = {
        ...
        price: 64.00,
        image:
          "https://websitedemos.net/recycled-shoe-store-04/wp-content/uploads/sites/983/2021/11/recycled-shoe-product-image-012-400x400.jpg",
      };
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="mb-4">
        <span className="title-font font-medium text-2xl text-black">${product.price}00</span>
